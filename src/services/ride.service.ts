...
export async function listRides(filters: { origin?: string; destination?: string }) {
  return prisma.ride.findMany({
    ...
    include: {
      ...
      requests: { select: { id: true, status: true, seatsRequested: true, hasLuggage: true, notes: true, userId: true, createdAt: true, rideId: true, user: { select: { id: true, name: true, email: true } } } },
    },
